  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response) throws java.io.IOException, ServletException {
    ...
    */
    ...
    try {
      ...
      WriteFileBean outFile;
      synchronized (pageContext) {
        if ((outFile = (WriteFileBean) pageContext.getAttribute( "outFile", PageContext.PAGE_SCOPE)) == null) {
          outFile = (WriteFileBean) new WriteFileBean();
          pageContext.setAttribute( "outFile", outFile, PageContext.PAGE_SCOPE);
          out.write(__oracle_jsp_text[2]);
          outFile.setFile("data.txt");
      ...
      out.write(__oracle_jsp_text[12]);
      {
        ...
        __jsp_taghandler_7.setTarget("${outFile}");
        __jsp_taghandler_7.setProperty("line");
