...
public class _ex4 extends com.orionserver.http.OrionHttpJspPage {
    ...
    */
    ...
    try {
      ...
      out.write(__oracle_jsp_text[5]);
      {
        ...
        __jsp_taghandler_4.setValue("${param.phone}");
      ...
      out.write(__oracle_jsp_text[6]);
      {
        ...
        __jsp_taghandler_5.setValue("${param.msg}");
      ...
      out.write(__oracle_jsp_text[7]);
      {
        ...
        __jsp_taghandler_6.setValue("${Math.random}");
  ...
  static {
    ...
    __oracle_jsp_text[5] = 
    ".\n   <P>The phone for this request is ".toCharArray();
    __oracle_jsp_text[6] = 
